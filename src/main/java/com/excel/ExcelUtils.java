...
public class ExcelUtils {
    ...
    /**
     * 方法exportExcelFile的功能描述：导出excel
     * @param dirPath 文件夹全路径名称
     * @param fileName 文件名称
     * @param xssMap excel文件对象
     * @return java.lang.String
     * @author fangxin
     * @date 2017-06-25 23:26
     * @version v2.0.0
     */
    public static String exportExcelFile(String dirPath,String fileName,Map<String,ExcelExportData> xssMap) {
        String filePath = null;
        try {
            exportExcelFile(xssMap);
            //写出文件到服务器
     ...
     * @throws Exception
     */
    public static XSSFWorkbook exportExcelFile(Map<String, ExcelExportData> xssMap) throws Exception {
        init();
        for (String s : xssMap.keySet()) {
            columNum = 0;
            String key = s;
            XSSFSheet sheet = wb.createSheet(key);
            sheet.setDefaultColumnWidth(40);
            ExcelExportData exportData = xssMap.get(key);
